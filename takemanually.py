    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "/home/princeton/Downloads/captone/1/Attendance-Management-system-using-face-recognition-master/Attendance/"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"/home/princeton/Downloads/captone/1/Attendance-Management-system-using-face-recognition-master/Attendance"'
                )
